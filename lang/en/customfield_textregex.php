...
$string['regex_help'] = 'Perl style regular expression to test the field value against. No need to define the delimiter; delimiter "/" is used and escaped internally. E.g: ^TEST[0-9A-F]{3}\/string$';
