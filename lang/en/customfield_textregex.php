...
$string['regex_help'] = 'Perl style regular expression to test the field value against. If field is not required, please also allow empty values in the regex. Please also include the delimiters. E.g: \"/^TEST[0-9A-F]{3}\/\$_postfix/\".';
